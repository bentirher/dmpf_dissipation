...
function build_full_U_mpo(n, J, t, k, sites, cutoff, maxdim, order)
    dt = t / k
...
function build_full_Udag_mpo(n, J, t, k, sites, cutoff, maxdim, order)
    dt = t / k
...
function build_F_direct_list(n, J, t, ks, sites, cutoff, maxdim; order::Int=1)
    Fs = MPO[]
    for ki in ks
        for kj in ks
